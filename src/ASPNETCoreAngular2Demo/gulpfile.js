...
gulp.task('copy-css',function(){
    return gulp.src('./angular2app/*.css')
...
//copy angular2-modal
gulp.task('copy-angular2-modal',function(){
    return gulp.src(buildConfig.sources.ng22bs3modal)
        .pipe(gulp.dest(buildConfig.rootJsFolder + 'ng2-bs3-modal/'));
});
